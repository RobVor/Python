...
class LibMe_Book_Application:
    def __init__(self, top=None):
        ...
        self.txtTitle.configure(highlightbackground="#d9d9d9")
        self.txtTitle.configure(highlightcolor="black")
        self.txtTitle.configure(insertbackground="black")
        self.txtTitle.configure(selectbackground="#c4c4c4")
        self.txtTitle.configure(selectforeground="black")
        ...
        self.txtYear.configure(selectbackground="#c4c4c4")
        self.txtYear.configure(selectforeground="black")
        ...
        self.lblISBN.configure(activebackground="#f9f9f9")
        self.lblISBN.configure(activeforeground="black")
        ...
        self.lblISBN.configure(highlightbackground="#d9d9d9")
        self.lblISBN.configure(highlightcolor="black")
        ...
        self.txtAuthor.configure(highlightbackground="#d9d9d9")
        self.txtAuthor.configure(highlightcolor="black")
        self.txtAuthor.configure(insertbackground="black")
        self.txtAuthor.configure(selectbackground="#c4c4c4")
        self.txtAuthor.configure(selectforeground="black")
        ...
        self.txtISBN.configure(highlightbackground="#d9d9d9")
        self.txtISBN.configure(highlightcolor="black")
        self.txtISBN.configure(insertbackground="black")
        self.txtISBN.configure(selectbackground="#c4c4c4")
        self.txtISBN.configure(selectforeground="black")
